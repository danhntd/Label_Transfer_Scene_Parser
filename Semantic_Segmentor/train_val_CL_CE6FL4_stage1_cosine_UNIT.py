...
class Trainer(object):
    def __init__(self, args):
        ...
        if args.optimizer == 'adam':
            ...
            scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=1488, eta_min=0) #5950 images
    ...
    def training(self, epoch):
        ...
        if self.lr_staget_ind > 1 and (epoch % 30 == 0 or epoch % 60 == 0 or epoch % 90 == 0): #and epoch % (self.lr_stage[self.lr_staget_ind]) == 0:
            current_lr = adjust_learning_rate(self.optimizer, self.args.lr_decay_gamma)
...
def main():
    args = parse_args()
    print('STAGE 1 combine loss CE 6 FL 4, cosine, UNIT daynight.')
    ...
    print('DONE STAGE 1 combine loss CE 6 FL 4, cosine, UNIT daynight.')
